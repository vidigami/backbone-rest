...
(function() {
  ...
  JoinTableControllerSingleton = (function() {
    ...
    JoinTableControllerSingleton.prototype.generateByOptions = function(app, options) {
      var err, join_table_auth, join_table_endpoint, join_table_options, join_table_parts, join_table_url, key, relation, route_parts, route_root, schema, _i, _key, _len, _ref, _ref1, _ref2, _results;
      ...
      for (key in _ref) {
        ...
        if (join_table_auth = (_ref2 = options.auth.relations) != null ? _ref2[key] : void 0) {
