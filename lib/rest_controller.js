...
(function() {
  var Backbone, JSONUtils, JoinTableControllerSingleton, ORMUtils, RESTController, getRequestPath, _,
  ...
  module.exports = RESTController = (function() {
    ...
    RESTController.prototype._reqToCRUD = function(req) {
      if (getRequestPath(req) === this.route) {
        switch (req.method) {
          case 'GET':
            return 'index';
          case 'POST':
      ...
      } else if (req.params.id && getRequestPath(req) === ("" + this.route + "/" + req.params.id)) {
        switch (req.method) {
          case 'GET':
            return 'show';
          case 'PUT':
