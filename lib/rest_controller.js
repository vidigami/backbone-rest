...
(function() {
  var Backbone, BackboneORM, JSONUtils, JoinTableControllerSingleton, ORMUtils, RESTController, path, _,
  ...
  module.exports = RESTController = (function() {
    ...
    RESTController.prototype.update = function(req, res) {
      ...
      return this.model_type.find(req.params.id, (function(_this) {
    ...
    RESTController.prototype.destroy = function(req, res) {
      ...
      return this.model_type.exists(req.params.id, (function(_this) {
    ...
    RESTController.prototype.destroyByQuery = function(req, res) {
      ...
      return this.model_type.destroy(JSONUtils.parse(req.query), (function(_this) {
        return function(err) {
          if (err) {
            return _this.sendError(res, err);
          }
    ...
    RESTController.prototype.headByQuery = function(req, res) {
      return this.model_type.exists(JSONUtils.parse(req.query), (function(_this) {
        return function(err, exists) {
          if (err) {
            return _this.sendError(res, err);
          }
    ...
    RESTController.prototype._reqToCRUD = function(req) {
      ...
      } else if (req.params.id && req_path === ("" + this.route + "/" + req.params.id)) {
        switch (req.method) {
          case 'GET':
            return 'show';
          case 'PUT':
